...
Begin detailed cybersecurity assessment with adaptive formatting based on codebase complexity:
    ...
    try {
      ...
      console.error("Streaming LLM Error:", streamError?.response?.data || streamError.message);
...
const chatMessage = async (req, res) => {
  try {
    ...
    const isCasualMessage = casualPatterns.some(pattern => pattern.test(message.trim()));
